...
def count_odometry(crd):
    ...
    for i in range(0, np.shape(crd)[1] - 1):
        Va = [crd[0, i+1] - crd[0, i], crd[1, i+1] - crd[1, i]]
...
if __name__ == '__main__':
    crd = np.array([[94, 97, 104, 118, 131, 150, 174, 200, 243, 281, 305, 328, 361, 393, 418, 447, 482, 504, 525, 538, 549, 559, 567, 577, 598, 613], [
                   78, 102, 127, 160, 180, 199, 220, 232, 246, 259, 263, 263, 263, 263, 266, 273, 281, 291, 303, 323, 345, 366, 390, 415, 453, 485]])
